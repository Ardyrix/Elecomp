...
public class Penjualan_Order_Order extends javax.swing.JFrame {
    ...
    public Penjualan_Order_Order() {
        ...
        AutoCompleteDecorator.decorate(comTable);
    }
    ...
    private void initComponents() {
        ...
        comTable = new javax.swing.JComboBox<>();
        ...
        comTable.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comTableActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 54, -1, -1));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 50, 252, 25));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 0, 204));
        jLabel16.setText("No. Order");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(336, 85, -1, -1));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 0, 204));
        jLabel17.setText("T.O.P");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(571, 54, -1, -1));
        ...
        getContentPane().add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(624, 52, 148, -1));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel18.setText("Keterangan Verifikasi");
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 148, -1, -1));
        ...
        if (tbl_Pembelian.getColumnModel().getColumnCount() > 0) {
            tbl_Pembelian.getColumnModel().getColumn(2).setCellEditor(new DefaultCellEditor(comTable));
        }

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 223, 844, 208));

        jLabel24.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(0, 0, 204));
        jLabel24.setText("Tanggal");
        getContentPane().add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(336, 51, -1, 24));

        jLabel25.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel25.setText("Total");
        getContentPane().add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(666, 446, -1, -1));

        jSeparator2.setForeground(new java.awt.Color(153, 153, 153));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 31, 864, -1));
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 6, -1, -1));
        ...
        getContentPane().add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 6, -1, -1));
        ...
        getContentPane().add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(148, 6, -1, -1));
        ...
        getContentPane().add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 6, 50, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 81, 252, 25));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 112, 252, 25));

        jLabel29.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(204, 0, 0));
        jLabel29.setText("Nama");
        getContentPane().add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 85, -1, -1));

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel30.setForeground(new java.awt.Color(204, 0, 0));
        jLabel30.setText("Alamat");
        getContentPane().add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 116, -1, -1));
        ...
        getContentPane().add(jTextField14, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 50, 150, 25));
        ...
        getContentPane().add(jTextField16, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 81, 150, 25));

        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(0, 0, 204));
        jLabel31.setText("Salesman");
        getContentPane().add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(336, 114, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BON TOKO", "AGUS", "AAA" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(404, 112, 150, -1));
        ...
        getContentPane().add(jTextField19, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 148, 701, 58));
        ...
        getContentPane().add(jTextField20, new org.netbeans.lib.awtextra.AbsoluteConstraints(704, 442, 150, 25));

        jSeparator1.setForeground(new java.awt.Color(153, 153, 153));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 473, 864, 10));

        jLabel22.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel22.setText("Kasir");
        getContentPane().add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 495, -1, -1));

        jLabel32.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel32.setText("Nama Kasir");
        getContentPane().add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 495, -1, -1));

        jSeparator3.setForeground(new java.awt.Color(153, 153, 153));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 510, 257, 10));

        jCheckBox1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jCheckBox1.setForeground(new java.awt.Color(153, 0, 0));
        jCheckBox1.setText("LGSG CETAK");
        getContentPane().add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 485, -1, -1));
        ...
        getContentPane().add(jTextField21, new org.netbeans.lib.awtextra.AbsoluteConstraints(546, 483, 150, 27));
        ...
        getContentPane().add(jTextField22, new org.netbeans.lib.awtextra.AbsoluteConstraints(702, 483, 150, 27));

        jSeparator6.setOrientation(javax.swing.SwingConstants.VERTICAL);
        getContentPane().add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(68, 0, -1, 30));

        jSeparator7.setOrientation(javax.swing.SwingConstants.VERTICAL);
        getContentPane().add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 0, -1, 30));

        jSeparator8.setOrientation(javax.swing.SwingConstants.VERTICAL);
        getContentPane().add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 0, -1, 30));
        ...
        getContentPane().add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, -1, 30));

        jSeparator9.setOrientation(javax.swing.SwingConstants.VERTICAL);
        getContentPane().add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 0, 10, 31));
    ...
    private void comTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comTableActionPerformed
    int kode_barang = 0;
        int baris = tbl_Pembelian.getRowCount();
        TableModel tabelModel;
        tabelModel = tbl_Pembelian.getModel();
        try {
            String sql = "select * from barang where nama_barang = '" + comTable.getSelectedItem() + "'";
            java.sql.Connection conn = (Connection) Koneksi.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                ...
                if (selectedRow != -1) {
                    ...
                    tbl_Pembelian.setValueAt(jumlah, selectedRow,3);
                    tbl_Pembelian.setValueAt(harga, selectedRow, 4);
                 
                  
//                    Tempharga = res.getString(11);
    ...
    }//GEN-LAST:event_comTableActionPerformed
    ...
    private javax.swing.JComboBox<String> comTable;
